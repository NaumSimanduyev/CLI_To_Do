# A simple CLI To Do app Instruction
Be sure that you keep main.py file in an empty folder because there will be created another file **data.json** in the **main.py** file directory.  
...
To remove a task you should type "3" in the main menu. Then you will see your current tasks. After that choose an appropriate date. You will see an ordered list of tasks related to this date.
